...
export default function FurnitureManager({ categories, setCategories, onBack }: FurnitureManagerProps) {
  ...
  const uploadImages = useCallback(async (item: FurnitureItem, fileList: File[] | FileList | null) => {
      ...
      <div className="max-w-lg mx-auto px-5">
        ...
        {mode === "list" && (
          <div className="pt-12 mb-6">
            <div className="flex items-center gap-2 mb-1">
              ...
              <h1 className="text-3xl font-light text-gray-900">가구 관리</h1>
            </div>
            <p className="text-sm text-gray-500">가구 후보 목록 관리</p>
        ...
        {mode === "create-category" && (
          <div className="pt-12 mb-6">
            ...
            <p className="text-sm text-gray-500">새로운 가구 카테고리를 추가하세요</p>
          </div>
        )}
        ...
        {mode === "create-item" && (
          <div className="pt-12 mb-6">
            <div className="flex items-center gap-2 mb-1">
              ...
              <h1 className="text-3xl font-light text-gray-900">가구 추가</h1>
            </div>
            <p className="text-sm text-gray-500">새로운 가구를 추가하세요</p>
          </div>
        )}
        ...
        {mode === "create-item" && (
          <div className="bg-gray-50 rounded-2xl p-4 mb-6 space-y-3">
            <div className="space-y-1">
              <div className="text-xs font-medium text-gray-600">가구명 *</div>
              <input 
                value={itemName}
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder="검색(카테고리/가구명/브랜드/모델)"
            ...
            {sortedCategories.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                <p className="text-sm">등록된 가구 카테고리가 없습니다</p>
              </div>
            ) : (
        ...
        <div className="fixed inset-0 z-[60] bg-white overflow-y-auto">
          <div className="max-w-lg mx-auto">
            <div className="flex items-center gap-2 p-4 border-b">
              ...
              <h3 className="text-base font-semibold">가구 상세</h3>
